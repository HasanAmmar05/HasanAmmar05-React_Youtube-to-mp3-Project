...
function YouTubeDownloader() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-purple-900 flex flex-col items-center p-8">
      ...
      <main className="w-full max-w-4xl bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden">
        <div className="p-8">
          <div className="relative mb-8">
            <input
              type="text"
              className="w-full px-6 py-4 bg-white bg-opacity-20 rounded-full text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-300"
            ...
            <div className="absolute right-2 top-2 flex space-x-2">
              <button
                ...
                className="p-2 bg-purple-600 text-white rounded-full font-semibold transform transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-purple-400 hover:bg-purple-700"
              ...
              <button
                ...
                className="p-2 bg-blue-600 text-white rounded-full font-semibold transform transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-400 hover:bg-blue-700"
                disabled={loading || !url}
              >
                <Info size={20} />
              </button>
          ...
          {error && (
            <div className="bg-red-500 bg-opacity-20 text-red-100 p-4 rounded-lg mb-6 animate-pulse">
              <p>{error}</p>
            </div>
          )}
          {videoInfo && (
            <div className="bg-white bg-opacity-10 rounded-2xl overflow-hidden shadow-xl mb-6 transition-all duration-300 hover:bg-opacity-20">
          ...
          {downloadLinks && (
            <div className="bg-white bg-opacity-10 rounded-2xl p-6 transition-all duration-300 hover:bg-opacity-20">
              <h3 className="text-xl font-semibold mb-4 text-white">Download Links</h3>
